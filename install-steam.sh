...
sudo xbps -Su
sudo xpbs-install steam mono libgcc-32bit libstdc++-32bit libdrm-32bit libglvnd-32bit mono mesa-32bit vulkan-loader mesa-dri-32bit amdvlk xf86-video-amdgpu mesa-vaapi mesa-vdpau MangoHud gamescope
